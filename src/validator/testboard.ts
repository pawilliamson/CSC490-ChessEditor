...
export class TestBoard {
    ...
    /**
     * This will test the directions the black pawn can move.
     * The only one tested is the one it should be able to move, down.
     * Expected: True
     *
     * @returns
     */
    ...
    /**
     * This will test that a black pawn can not move onto a
     * space with the same color of piece.
     * Expected: False
     *
     * @returns
     */
    ...
    /**
     * This will test the directions the white pawn can move.
     * All the directions other than the one that it can move, down, are tested.
     * Expected: False
     *
     * @returns
     */
    ...
    /**
     * This will test the directions that any rook can move.
     * It will only test directly horizontal and vertical movements.
     * Expected: True
     *
     * @returns
     */
    ...
    testRookMovement2() {
        ...
        const blackRook = new Rook('BLACK');
        this.testBoard.chessBoard[3][3] = blackRook;
	    return this.testBoard.validateMovement(3, 3, 2, 4) ||
		    this.testBoard.validateMovement(3, 3, 2, 5);
    }

    /**
     * This will test a rook trying to move to a space that it would
     * normally be able to move to, but is blocked by another piece,
     * one of the same color, one of another color.
     * Expected: False
     *
     * @returns
     */
    testRookMovement3() {
	    ...
	    return this.testBoard.validateMovement(3, 3, 1, 3) ||
		    this.testBoard.validateMovement(3, 3, 3, 6);
    }

    /**
     * This will test a rook trying to move to a space
     * that is occupied by another piece, one enemy piece and one friendly piece.
     * Expected: True
     *
     * @returns
     */
    ...
    /**
     * This will test the directions a bishop can't move,
     * including horizontal and vertical and movements that are not directly diagonal.
     * Expected: False
     *
     * @returns
     */
    ...
    /**
     * This will test if the bishop can move if it's path
     * is blocked by either a piece of it's own color or the opponent's piece.
     * Expected: False
     *
     * @returns
     */
    testBishopMovement3() {
	    ...
	    return this.testBoard.validateMovement(3, 3, 0, 6) ||
		    this.testBoard.validateMovement(3, 3, 5, 1);
    }
    ...
    /**
     * This will test that the knight can move to a space
     * that's occupied by an enemy, but not to a space occupied
    ...
    testQueenMovement3() {
	    ...
	    return this.testBoard.validateMovement(3, 3, 0, 3)
		    || this.testBoard.validateMovement(3, 3, 6, 3);
    }
    ...
    testQueenMovement4() {
        ...
        this.testBoard.chessBoard[5][3] = blackQueen;
	    return !this.testBoard.validateMovement(3, 3, 5, 3)
		    && this.testBoard.validateMovement(3, 3, 0, 3);
    }
