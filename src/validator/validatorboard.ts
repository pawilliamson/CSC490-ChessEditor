...
export class ValidatorBoard extends Board {
	...
	goodDiagonalPathChecker(x1: number, y1: number, x2: number, y2: number) {
		...
		let xChange: number = x2 - x1;
		let yChange: number = y2 - y1;
		...
		var xChangePerSpace: number = 1 / xChange;

		var yChangePerSpace: number = 1 / yChange;
	...
	goodHorizontalVerticalPathChecker(x1: number, y1: number, x2: number, y2: number) {
		...
		let xChangePerSpace: number = 1 / xChange;
		let yChangePerSpace: number = 1 / yChange;
